<div class="users index" style="overflow-x:scroll;">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('student_major'); ?></th>
			<th><?php echo $this->Paginator->sort('student_graduation_date'); ?></th>
			<th><?php echo $this->Paginator->sort('publisher_id'); ?></th>
			<th><?php echo $this->Paginator->sort('publisher_rating'); ?></th>
			<th><?php echo $this->Paginator->sort('professor_rating'); ?></th>
